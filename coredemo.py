...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        type=int,
        help='number of training epochs for batch learning scenario')
    parser.add_argument(
        '--profiler-tests',
        dest='tests',
        action='store_true',
    ...
    if True:
        ...
        for batch in tqdm(batches, desc='Batches', position=0):
            ...
            if train_type > 0 and train_replay and n_episodes > 0:
